...
const App = () => {
  ...
  // const onUpdateChannel = async (id, selected) => {
  //   await axios.patch(`http://localhost:8000/channels/${id}`, {
  //     selected: !selected,
  //   })
  // }
  ...
  return (
    <ChannelContext.Provider value={{ myChannels, moreChannels, onUpdateChannel }}>
      <div className="app">
        <Home />
      </div>
